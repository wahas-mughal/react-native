...
import { Container, Header, Content, Card, CardItem, Text, Body, Left, Icon, Right, Badge} from "native-base";
...
const ReviewHistory = (props) => {
    return (
        ...
        <Header style = {{backgroundColor: '#0065ff'}}>
          <Left>
            <Icon name = 'ios-menu' style = {{fontSize: 28, color: '#fff'}} onPress = {() => props.navigation.openDrawer() }/>
          </Left>
          <Body/>
          <Right/>
          </Header>
        ...
        <TouchableOpacity onPress = {() => {}}>
          <Card>
            <CardItem header bordered>
              <Text style = {{fontWeight: 'bold', color: '#0065ff', fontSize: 17}}>Habib Restaurant</Text>
            </CardItem>
            <CardItem bordered>
              <Body>
                <Text>
            ...
            <CardItem header bordered>
              <Text style = {{color: '#0065ff', fontWeight: 'bold'}}>You Rated: </Text>
            </CardItem>
